    ...
    <section id="hero" className='container mx-auto px-5 md:px-8 py-12 lg:py-20'>
      <div className='flex flex-col lg:flex-row gap-10 lg:gap-14 items-center justify-between'>
        ...
        <div className='order-2 lg:order-1 text-center lg:text-left'>
          <h3 className='text-xl lg:text-2xl font-medium text-gray-800'>👋 Hi, I'm Bharat Jawa</h3>
          ...
          <div className='flex flex-col sm:flex-row justify-center lg:justify-start gap-4 md:gap-6 mt-8'>
            <button className='h-12 px-6 text-sm md:text-base font-medium text-amber-900 rounded-full border-2 border-amber-900 transition-all duration-300 hover:scale-105 hover:shadow-md'>
              View my Work
            </button>
            <button className='h-12 px-6 text-sm md:text-base font-medium text-white bg-gradient-to-r from-amber-700 to-amber-900 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-md'>
              Download Resume
            </button>
          </div>
        </div>
